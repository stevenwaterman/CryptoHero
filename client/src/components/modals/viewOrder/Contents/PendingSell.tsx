...
export default class PendingSell extends React.Component<ViewTradeModalProps> {
    render(): ELEMENT {
        ...
        const gained = average.mul(units.sub(remainingUnits));
        return <>
            <Modal.Body>
                <b>ID:</b> {id}<br/>
                ...
                <hr className="col-12"/>
                <b>Sold:</b> {formatMoney(units.sub(remainingUnits), 5, true, true)} {instrument.asset2}<br/>
                ...
                <b>Expecting:</b> {formatMoney(remainingUnits.mul(unitPrice), 5, true, true)} {instrument.asset1}<br/>
                <b>Total:</b> {formatMoney(gained.plus(remainingUnits.mul(unitPrice)), 5, true, true)} {instrument.asset1}<br/>
            </Modal.Body>
            <Modal.Footer>
