...
export default class Order {
    ...
    constructor(account, direction, units, unitPrice) {
        ...
        this.spendAmount = this.direction === TradeDirection.BUY ? this.units * this.unitPrice : this.units;
        this.gainAmount = this.direction === TradeDirection.BUY ? this.units : this.units * this.unitPrice;
    }
}
